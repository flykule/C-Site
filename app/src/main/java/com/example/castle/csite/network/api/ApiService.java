...
import com.example.castle.csite.bean.RecommendAnimationRegion;
...
public interface ApiService {
    ...
    //用于刷新动画区的内容
    @GET("http://www.bilibili.com/index/ding/1.json?appkey=1d8b6e7d45233436&build=426003&mobi_app=android&platform=android&sign=3d0104bb6fe22ae80e98a223b70bad6f")
    Observable<RecommendAnimationRegion> getRecommendAnimationRegion();
